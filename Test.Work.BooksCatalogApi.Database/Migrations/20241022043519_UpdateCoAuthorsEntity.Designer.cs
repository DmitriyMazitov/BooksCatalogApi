...
namespace Test.Work.BooksCatalogApi.Database.Migrations
{
    ...
    [Migration("20241022043519_UpdateCoAuthorsEntity")]
    partial class UpdateCoAuthorsEntity
    {
            ...
            modelBuilder.Entity("Test.Work.BooksCatalogApi.BLL.Entities.СoAuthor", b =>
                {
                    ...
                    b.HasIndex("AuthorId")
                        .HasDatabaseName("ix_сo_author_author_id");

                    b.HasIndex("BookId")
                        .HasDatabaseName("ix_сo_author_book_id");
            ...
            modelBuilder.Entity("Test.Work.BooksCatalogApi.BLL.Entities.СoAuthor", b =>
                {
                    b.HasOne("Test.Work.BooksCatalogApi.BLL.Entities.Author", "AuthorEntity")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_сo_author_authors_author_id");
                    ...
                    b.HasOne("Test.Work.BooksCatalogApi.BLL.Entities.Book", "BookEntity")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_сo_author_books_book_id");
