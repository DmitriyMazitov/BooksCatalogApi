...
namespace Test.Work.BooksCatalogApi.Database.Migrations
{
    ...
    [Migration("20241022043814_UpdateEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test.Work.BooksCatalogApi.BLL.Entities.CoAuthor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("AuthorId")
                        .HasDatabaseName("ix_co_authors_author_id");

                    b.HasIndex("BookId")
                        .HasDatabaseName("ix_co_authors_book_id");

                    b.ToTable("co_authors", "public");
                });
            ...
            modelBuilder.Entity("Test.Work.BooksCatalogApi.BLL.Entities.CoAuthor", b =>
                {
                    b.HasOne("Test.Work.BooksCatalogApi.BLL.Entities.Author", "AuthorEntity")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_co_authors_authors_author_id");
                    ...
                    b.HasOne("Test.Work.BooksCatalogApi.BLL.Entities.Book", "BookEntity")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_co_authors_books_book_id");
