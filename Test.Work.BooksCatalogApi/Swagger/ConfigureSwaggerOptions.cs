...
namespace Test.Work.BooksCatalogApi.Swagger
{
	...
	public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
    {
        ...
        public void Configure(SwaggerGenOptions options)
        {
            ...
            options.IncludeXmlCommentsIfExists(typeof(Test.Work.BooksCatalogApi.BLL.Entry).Assembly);
            options.IncludeXmlCommentsIfExists(typeof(Test.Work.BooksCatalogApi.Database.Entry).Assembly);
