...
namespace Test.Work.BooksCatalogApi.BLL.Extensions
{
	...
	public static class QueryableExtensions
    {
        ...
        /// <summary>
        /// Применить сортировку с дополнительной сортировкой
        /// <see cref="IPaginationQuery"/>
        /// </summary>
        /// <typeparam name="T">Тип IQueryable</typeparam>
        /// <typeparam name="TKey">Поле для дополнительной сортировки</typeparam>
        /// <param name="queryable">IQueryable</param>
        /// <param name="orderBy">Сортировка</param>
        /// <param name="thenByField">Дополнительное поле для сортировки</param>
        /// <returns>IQueryable с сортировкой</returns>
        public static IQueryable<T> OrderBy<T, TKey>(
            this IQueryable<T> queryable,
            IOrderByQuery orderBy,
            Expression<Func<T, TKey>> thenByField)
        {
            if (queryable == null)
                throw new ArgumentNullException(nameof(queryable));
            ...
            return queryable
                .OrderByField(orderBy.OrderBy, orderBy.IsAscending)
                .ThenBy(thenByField);
        }
